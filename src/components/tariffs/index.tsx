...
Минимальный 
14990
 ⁃ уроки два раза в неделю
 ⁃ участие в разговорных клубах
 ⁃ доступ к платформе - 1 месяц после окончания

19890
 ⁃ уроки два раза в неделю
 ⁃ участие в разговорных клубах
 ⁃ обратная связь с проверкой д/з
 ⁃ бонусные материалы
 ⁃ доступ к платформе - 2 месяца
...
function Tariffs() {
  ...
  return (
    <Box>
      ...
      <Typography sx={{ textAlign: 'center' }} component='div' variant='h5'>Тарифы:</Typography>
